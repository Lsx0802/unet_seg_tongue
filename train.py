...
def main():
    ...
    train_img_paths = r"C:\Users\hello\PycharmProjects\Unet2D_tongue_2/dataset/train_images/"
    train_mask_paths = r"C:\Users\hello\PycharmProjects\Unet2D_tongue_2\dataset\train_masks/"
    val_img_paths = r"C:\Users\hello\PycharmProjects\Unet2D_tongue_2\dataset\val_images/"
    val_mask_paths = r"C:\Users\hello\PycharmProjects\Unet2D_tongue_2\dataset\val_masks/"
    train_img_paths1 = os.listdir(train_img_paths)
    val_img_paths1 = os.listdir(val_img_paths)
    print("train_num:%s" % str(len(train_img_paths1)))
    print("val_num:%s" % str(len(val_img_paths1)))
    ...
    train_dataset = MyDataset(train_img_paths, train_mask_paths, transform=train_transform)
    val_dataset = MyDataset(val_img_paths, val_mask_paths, transform=val_transform)
